...
// Point Person(s) — member picker backed by the Users collection.
// Uses the same shared component and member list as the Requesting Head
// selector, so neither field can drift from the other.
...
// Point persons — names for display, ids for the structured reference
...
return {
    ...
    pointPersons,
    // Structured references alongside the display names
...
/* ==========================================================
   Requesting Head — the shared selector from common.js.

   The implementation lives in IMC.createRequestingHead() so the
   Rollout Form uses the identical component. window.RequestingHead is
   kept as the handle collectFormData() and the validators already read.
========================================================== */
